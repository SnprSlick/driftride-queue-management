        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerRide = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ApiIntegrationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    ApiCredentials = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_QueueEntries_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customer_Name_CreatedAt",
                table: "Customers",
                columns: new[] { "Name", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentConfiguration_PaymentMethod_Unique",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payment_CustomerId_Status",
                table: "Payments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueEntry_CustomerId",
                table: "QueueEntries",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueEntry_PaymentId",
                table: "QueueEntries",
                column: "PaymentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QueueEntry_Position",
                table: "QueueEntries",
                column: "Position",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QueueEntry_Status_Position",
                table: "QueueEntries",
